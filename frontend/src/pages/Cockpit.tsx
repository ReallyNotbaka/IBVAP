...
export function Cockpit({
  ...
  return (
    <div className="flex flex-col gap-5 max-w-[1400px] mx-auto w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white/80 dark:bg-[#131720]/80 border border-slate-200/80 dark:border-white/10 rounded-2xl px-5 py-3.5 backdrop-blur-xl shadow-sm transition-colors">
      ...
      <div className="w-full flex flex-col items-center">
        ...
        {n > 0 && (
          <div className="control-pill-bar mt-3 w-full max-w-[1200px] flex flex-wrap items-center justify-between gap-3 px-4 py-2.5 rounded-2xl bg-white/85 dark:bg-[#131720]/90 backdrop-blur-xl border border-slate-200/80 dark:border-white/10 shadow-md transition-colors">
            ...
            {/* Center: 👁️ Overlay Presets Segmented Bar */}
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800">
              <div className="flex items-center gap-2.5">
                <div className="h-8 w-8 rounded-xl bg-rose-50 dark:bg-rose-950/60 border border-rose-200 dark:border-rose-900/50 flex items-center justify-center text-rose-500 text-base">
                  🔔
                </div>
                <div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      {s.thumbnail_b64 ? (
                        ...
                        <div className="h-10 w-10 rounded-lg bg-rose-100 dark:bg-rose-950 border border-rose-200 dark:border-rose-900/50 flex items-center justify-center text-lg">
                          👤
                        </div>
                      )}
                      <div>
